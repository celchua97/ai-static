          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            {variations.length === 0 ? (
              <div className="text-center py-12 text-gray-500">
                ...
                <p>Upload an image to get AI-powered variation suggestions</p>
              </div>
            ) : (
              <div className="space-y-6">
                ...
                <div className="mt-8 p-6 bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl border">
                  ...
                  <ul className="text-sm text-gray-700 space-y-1">
                    ...
                    <li>• Focus on high-priority variations first for maximum impact</li>
                  </ul>
                </div>
              </div>
            )}
